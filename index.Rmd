...
The external validity of my research may not be very high, as the amount of tracks in each playlist is quite low. Furthermore while these particular two genres might not be an immensly useful comparison, they are two of the genres I grew up to and i thoroughlyenjoyed listening to some of my nostalgic favourites and learning how effective and efficient R is for data visualisation at the same time. 
