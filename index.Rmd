...
While the precision stays the same, the recall goes up by 3/4% . The confusion matrix is shown on the left. The the SVM does a very good job at distinguishing between the two.
